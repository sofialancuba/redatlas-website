...
$(function () {
  ...
  $("#contactForm input,#contactForm textarea").jqBootstrapValidation({
    ...
    submitSuccess: function (a, t) {
      ...
      var e = $("input#name").val(),
        ...
        o = e;
      o.indexOf(" ") >= 0 && (o = e.split(" ").slice(0, -1).join(" ")),
        $.ajax({
          url: "././mail/contact_me.php",
          type: "POST",
          data: { name: e, phone: n, email: i, message: r },
          cache: !1,
          success: function () {
  ...
  (function (a) {
    ...
    var i = [],
            ...
            return (
                ...
                r
                  ...
                  n
                    ? (e.options.preventSubmit && t.preventDefault(),
                      i.addClass("error"),
                      a.isFunction(e.options.submitError) &&
                    ...
                    : (i.removeClass("error"),
                      a.isFunction(e.options.submitSuccess) &&
              ...
              this.each(function () {
                ...
                if (
                  ...
                  void 0 !== t.attr("maxlength") &&
                    ...
                    (void 0 !== t.attr("required") ||
                      ...
                      ((c = e.builtInValidators.required.message),
                    ...
                    void 0 !== t.attr("type") &&
                      ...
                      ((c = e.builtInValidators.number.message),
                ...
                var g = d,
                  v = [];
                do
                  a.each(d, function (a, t) {
                    d[a] = r(t);
                  }),
                    (d = a.unique(d)),
                    (v = []),
                    a.each(g, function (i, n) {
                ...
                a.each(d, function (i, n) {
                  ...
                  if (
                    ...
                    a.each(e.validatorTypes, function (e, i) {
                      void 0 === h[e] && (h[e] = []),
                        l ||
                          void 0 === t.data("validation" + n + r(i.name)) ||
                          (h[e].push(
                            a.extend(
                              !0,
                      ...
                      : a.each(e.validatorTypes, function (e, i) {
                          void 0 === h[e] && (h[e] = []),
                            l ||
                              ...
                              h[c].push(a.extend(d, i.init(t, n))),
                              (l = !0));
                        });
                  }
                  ...
                  t.bind("validation.validation", function (i, n) {
                    var r = o(t),
                      s = [];
                    return (
                      a.each(h, function (i, o) {
                        (r ||
                          r.length ||
                          (n && n.includeEmpty) ||
                          (e.validatorTypes[i].blockSubmit &&
                            n &&
                            n.submitting)) &&
                          a.each(o, function (a, n) {
                            e.validatorTypes[i].validate(t, r, n) &&
                              s.push(n.message);
                          });
                      }),
                      s
                      ...
                      n.find("input,textarea,select").each(function (e, i) {
                        ...
                        c.length
                          ? (n.removeClass("success error").addClass("warning"),
                            e.options.semanticallyStrict && 1 === c.length
                              ? s.html(
                                  c[0] +
        ...
        validatorTypes: {
          ...
          ajax: {
            ...
            validate: function (t, e, i) {
              return "" + i.lastValue == "" + e && i.lastFinished === !0
                ? i.lastValid === !1
                : (i.lastFinished === !0 &&
                    ((i.lastValue = e),
                    (i.lastValid = !0),
          ...
          regex: {
            name: "regex",
            init: function (a, e) {
              return { regex: t(a.data("validation" + e + "Regex")) };
            },
            validate: function (a, t, e) {
              return (
                (!e.regex.test(t) && !e.negative) ||
                (e.regex.test(t) && e.negative)
              );
            },
          },
          required: {
            ...
            validate: function (a, t, e) {
              return (
                !(0 !== t.length || e.negative) ||
                !!(t.length > 0 && e.negative)
              );
            },
            blockSubmit: !0,
          },
          ...
          maxchecked: {
            ...
            validate: function (a, t, e) {
              return (
                (e.elements.filter(":checked").length > e.maxchecked &&
                  !e.negative) ||
                (e.elements.filter(":checked").length <= e.maxchecked &&
                  e.negative)
              );
          ...
          minchecked: {
            ...
            validate: function (a, t, e) {
              return (
                (e.elements.filter(":checked").length < e.minchecked &&
                  !e.negative) ||
                (e.elements.filter(":checked").length >= e.minchecked &&
                  e.negative)
              );
      ...
      o = function (t) {
        ...
        return (
          ...
          "radio" === i &&
            (e =
              a('input[name="' + t.attr("name") + '"]:checked').length > 0
                ? e
                : ""),
          e
        );
    ...
    (a.fn.jqBootstrapValidation = function (t) {
      return n.methods[t]
        ? n.methods[t].apply(this, Array.prototype.slice.call(arguments, 1))
        : "object" != typeof t && t
        ? (a.error(
            "Method " + t + " does not exist on jQuery.jqBootstrapValidation"
          ),
          null)
