...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(".bg-img").parallax("50%", 0.12);
    $(".bg-img2").parallax("50%", 0.12);
    $(".bg-img3").parallax("50%", 0.12);
    $(".bg-img4").parallax("50%", 0.12);
    $(".bg-img5").parallax("50%", 0.12);
    ...
    var researchHoverOrClick = function () {
      $("#research").addClass("btn-outline-red");
      $("#research-item").removeClass("d-none");
      $("#mass-item").addClass("d-none");
      $("#api-item").addClass("d-none");
      $("#mass").removeClass("btn-outline-red");
      $("#api").removeClass("btn-outline-red");
    };
    $("#research").click(researchHoverOrClick).hover(researchHoverOrClick);

    var massHoverOrClick = function () {
      $("#mass").addClass("btn-outline-red");
      $("#mass-item").removeClass("d-none");
      $("#research-item").addClass("d-none");
      $("#api-item").addClass("d-none");
      $("#research").removeClass("btn-outline-red");
      $("#api").removeClass("btn-outline-red");
    };
    $("#mass").click(massHoverOrClick).hover(massHoverOrClick);

    var apiHoverOrClick = function () {
      $("#api").addClass("btn-outline-red");
      $("#api-item").removeClass("d-none");
      $("#research-item").addClass("d-none");
      $("#mass-item").addClass("d-none");
      $("#research").removeClass("btn-outline-red");
      $("#mass").removeClass("btn-outline-red");
    ...
    var listHoverOrClick = function () {
      ...
      $("#access-item").addClass("d-none");
      $("#x-item").addClass("d-none");
      $("#access").removeClass("btn-outline-red");
      $("#x").removeClass("btn-outline-red");
    };
    $("#list").click(listHoverOrClick).hover(listHoverOrClick);

    var accessHoverOrClick = function () {
      $("#access").addClass("btn-outline-red");
      $("#access-item").removeClass("d-none");
      $("#list-item").addClass("d-none");
      $("#x-item").addClass("d-none");
      $("#list").removeClass("btn-outline-red");
      $("#x").removeClass("btn-outline-red");
    };
    $("#access").click(accessHoverOrClick).hover(accessHoverOrClick);

    var xHoverOrClick = function () {
      $("#x").addClass("btn-outline-red");
      $("#x-item").removeClass("d-none");
      $("#list-item").addClass("d-none");
      $("#access-item").addClass("d-none");
      $("#list").removeClass("btn-outline-red");
      $("#access").removeClass("btn-outline-red");
